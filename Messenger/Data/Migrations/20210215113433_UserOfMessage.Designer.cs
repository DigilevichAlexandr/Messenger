...
namespace Messenger.Data.Migrations
{
    ...
    [Migration("20210215113433_UserOfMessage")]
    partial class UserOfMessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Messenger.Data.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Messenger.Data.Entities.FullName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Messenger.Data.Entities.WorkingPlace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Messenger.Data.Entities.Employee", b =>
                {
                    b.HasOne("Messenger.Data.Entities.FullName", "FullName")
                        .WithMany()
                        .HasForeignKey("FullNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Messenger.Data.Entities.WorkingPlace", "WorkingPlace")
                        .WithMany()
            ...
            modelBuilder.Entity("Messenger.Data.Entities.Message", b =>
                {
                    b.HasOne("Messenger.Data.Entities.Employee", "Employee")
                        .WithMany("Messages")
